...
<hr>
 ...
 |---|---|---|
 | Real time process monitoring project | [Repository link](https://github.com/Thilina-Upendra/Real-Time-Process-Monitoring.git) | Real-time process monitoring system implemented for the cutting section in Apparel Industry  |
 | UpText - Personal text editor | [Repository link](https://github.com/Thilina-Upendra/Personal-Text-Editor-Project.git) | 'UpText' is a personal text editor that is implemented according to the user's requirement. |
 | Student's attendance system | [Repository link](https://github.com/Thilina-Upendra/Student-Attendance-Project.git) | Student's attendance system  |
 | Google Clone | [Repository link](https://github.com/Thilina-Upendra/Google-Clone.git) | Exactly a clone project of google search engine. [Project Link](https://thilina-upendra.github.io/Google-Clone/) |
 | Simple ORM Framework | [Repository link](https://github.com/Thilina-Upendra/Simple-ORM-framework.git) | A simple framework which can create a database with simple Objects mapping system. |
 | Google task clone backend | [Repository link](https://github.com/Thilina-Upendra/google-task-clone-backend.git) | A clone project which can manage tasks same as Google task. |
...
<p><img align="center" src="https://github-readme-stats.vercel.app/api/top-langs?username=thilina-upendra&show_icons=true&locale=en&layout=compact" alt="thilina-upendra" /></p>
